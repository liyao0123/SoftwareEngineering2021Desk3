...
false_area VARCHAR(20) NOT NULL,
...
(NULL,'African penguin','Africa','Asia','1) Historical exploitation. 2) Oil spills. 3) Competition with fisheries. ','https://en.wikipedia.org/wiki/African_penguin','/images/African_penguin.jpg','60–70 cm tall and weigh between 2.2–3.5 kg 
...
These penguins have the nickname "jackass penguin", which comes from the loud noises they make.',NULL),
(NULL,'Siberian tiger','Asia','Europe','1) Low genetic diversity. 2) Geographic isolation. 3) Poaching. ','https://en.wikipedia.org/wiki/Siberian_tiger','/images/Siberian_tiger.jpg','The tiger is reddish-rusty, or rusty-yellow in colour, with narrow black transverse stripes.
The body length is not less than 150 cm , condylobasal length of skull 250 mm, zygomatic width 180 mm, and length of upper carnassial tooth over 26 mm  long. It has an extended supple body standing on rather short legs with a fairly long tail.',NULL),
(NULL,'Asian elephant','Asia','Africa','1) Loss, degradation and fragmentation of  habitats. 2) Human hunting. ','https://en.wikipedia.org/wiki/Asian_elephant','/images/Asian_elephant.jpg','In general, the Asian elephant is smaller than the African bush elephant and has the highest body point on the head.
...
The forehead has two hemispherical bulges, unlike the flat front of the African elephant.',NULL),
(NULL,'African wild dog','Africa','Europe','1) Habitat fragmentation. 2) Herder’s hunting. ','https://en.wikipedia.org/wiki/African_wild_dog','/images/African_wild_dog.jpg','Compared to members of the genus Canis, the African wild dog is comparatively lean and tall, with outsized ears and lacking dewclaws. 
...
The tail is usually white at the tip, black in the middle and brown at the base.',NULL),
(NULL,'Giant otter','America','Asia','1) Poaching has long been a problem. 2) Habitat destruction and degradation. 3) Conflict with fishermen.','https://en.wikipedia.org/wiki/Giant_otter','/images/Giant_otter.jpg','It has the greatest body length of any species in the mustelid family, although the sea otter may be heavier.
...
The nose (or rhinarium) is completely covered in fur, with only the two slit-like nostrils visible.',NULL);



INSERT INTO fauna VALUES
(NULL,'Bonobo','Africa','Asia','1) Habitat loss. 2) Human hunting and war.','https://en.wikipedia.org/wiki/Bonobo','/images/Bonobo.jpg','The bonobo is commonly considered to be more gracile than the common chimpanzee. Adult female bonobos are somewhat smaller than adult males.
...
The bonobo also has a slim upper body, narrow shoulders, thin neck, and long legs when compared to the common chimpanzee.','Hominidae'),
(NULL,'Bornean orangutan','Asia','America','1) Illegal logging, fire and the extensive development of palm oil plantations by human. 2) Climate change
...
Males have a more pronounced beard and mustache. The throat sac in males is also considerably larger. There are two body types for sexually mature males: smaller or larger. Larger males are more dominant but smaller males still breed successfully. There is little sexual dimorphism at birth.','Hominidae'),
(NULL,'Chimpanzee','Africa','Europe','1) Habitat destruction. 2) Human poaching. 3) Infectious diseases ','https://en.wikipedia.org/wiki/Chimpanzee','/images/Chimpanzee.jpg','Adult chimpanzees have an average standing height of 150 cm. 
...
','Hominidae'),
(NULL,'Eastern lowland gorilla','Africa','Asia','1) Poaching. 2) Civil unrest. 3) Habitat destruction ','https://en.wikipedia.org/wiki/Eastern_lowland_gorilla','/images/Eastern_lowland_gorilla.jpg','It is the largest of the four gorilla subspecies. 
...
The male''s coat, like that of other gorillas, greys as the animal matures, resulting in the designation "silverback".','Hominidae');
